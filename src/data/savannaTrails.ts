...
export const savannaTrails: SavannaTrail[] = [
  ...
  },
  {
    ...
    coordinates: [
      ...
      { lat: -0.9128, lng: 36.4585 },
      { lat: -0.9105, lng: 36.4612 },
      { lat: -0.9078, lng: 36.4645 },
      { lat: -0.9045, lng: 36.4682 },
      { lat: -0.9008, lng: 36.4725 },
      { lat: -0.8965, lng: 36.4772 },
      { lat: -0.8918, lng: 36.4825 },
      { lat: -0.8865, lng: 36.4882 },
      { lat: -0.8808, lng: 36.4945 },
      { lat: -0.8745, lng: 36.5012 },
      { lat: -0.8678, lng: 36.5085 },
      { lat: -0.8605, lng: 36.5162 },
      { lat: -0.8528, lng: 36.5245 },
      { lat: -0.8445, lng: 36.5332 },
      { lat: -0.8358, lng: 36.5425 },
      { lat: -0.8265, lng: 36.5522 },
      { lat: -0.8168, lng: 36.5625 },
      { lat: -0.8065, lng: 36.5732 },
      { lat: -0.7958, lng: 36.5845 },
      { lat: -0.7845, lng: 36.5962 },
      { lat: -0.7728, lng: 36.6085 },
      { lat: -0.7605, lng: 36.6212 },
      { lat: -0.7478, lng: 36.6345 },
      { lat: -0.7345, lng: 36.6482 },
      { lat: -0.7208, lng: 36.6625 },
      { lat: -0.7065, lng: 36.6772 },
      { lat: -0.6918, lng: 36.6925 },
      { lat: -0.6765, lng: 36.7082 },
      { lat: -0.6608, lng: 36.7245 },
      { lat: -0.6445, lng: 36.7412 },
      { lat: -0.6278, lng: 36.7585 },
      { lat: -0.6105, lng: 36.7762 },
      { lat: -0.5928, lng: 36.7945 },
      { lat: -0.5745, lng: 36.8132 },
      { lat: -0.5558, lng: 36.8325 },
      { lat: -0.5365, lng: 36.8522 },
      { lat: -0.5168, lng: 36.8725 },
      { lat: -0.9142, lng: 36.4561 },
    ],
    waypoints: [
      { id: 'longonot-gate', name: 'Park Gate', lat: -0.9142, lng: 36.4561, elevationM: 2148, kind: 'start' },
      { id: 'rim-east', name: 'Crater Rim (east)', lat: -0.8265, lng: 36.5522, elevationM: 2600, kind: 'checkpoint' },
      { id: 'rim-peak', name: 'Highest Rim Point', lat: -0.6608, lng: 36.7245, elevationM: 2776, kind: 'summit' },
